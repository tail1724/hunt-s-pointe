  ...
  return (
    <section className="page active" id="home"><div className="wrap">
      <header className="hero">
        <div>
          <p className="eyebrow reveal" style={{ ['--d' as any]: '.05s' }}>Ezra · give the hours back</p>
          <h1>
            <span className="reveal" style={{ ['--d' as any]: '.12s' }}>Hours of study,</span>
          ...
          <p className="sub lead reveal" style={{ ['--d' as any]: '.34s' }}>
            Ezra gives you back the hours you'd lose hunting through commentaries — mapping your exegesis, synthesizing the sources, and gathering your cross-references, with <b>every claim cited to its source</b>. You still write the sermon. Ezra just clears the runway.
          </p>
          <div className="cta-row reveal" style={{ ['--d' as any]: '.44s' }}>
            <AuthCTA className="btn btn--ink"><ArrowBtn>Start free</ArrowBtn></AuthCTA>
            <Link to="/#how" className="btn btn--ghost" onClick={(e) => { e.preventDefault(); document.getElementById('how')?.scrollIntoView({ behavior: 'smooth' }); }}>See Ezra work</Link>
          </div>
          ...
          <p className="hero-stat reveal" style={{ ['--d' as any]: '.56s' }}>
            Weekly worship attendance has slipped to <b>30%</b> of U.S. adults, while <b>90%</b> of pastors report chronic fatigue.<span className="hero-stat__src">Gallup · Schaeffer Institute, 2026</span> Every hour Ezra saves on research is an hour given back to your people.
          </p>
          <div className="proof reveal" style={{ ['--d' as any]: '.6s' }}>
            <span className="proof__lead">Every answer, accountable</span>
            <span className="proof__i"><span className="k">hours back</span><span>every week, not spent hunting commentaries</span></span>
            <span className="proof__i"><span className="n">5</span><span>public-domain translations, licensed clean</span></span>
            <span className="proof__i"><span className="k">cited</span><span>no anonymous claims, ever</span></span>
            <span className="proof__i"><span className="k">yours</span><span>you write the sermon</span></span>
          </div>
        </div>
        <aside className="panel study reveal" style={{ ['--d' as any]: '.4s' }} aria-label="Example of Ezra's cited study for Luke 15">
          <div className="bar" aria-hidden="true">
            <span className="dot"></span><span className="dot"></span><span className="dot"></span>
            <span className="stag">STUDY · THIS WEEK</span>
          </div>
          <div className="body">
            <p className="ref">Luke 15 — The Parables of the Lost</p>
            <ul className="outline">
              <li>I. The lost sheep — one in a hundred</li>
              <li>II. The lost coin — one in ten</li>
              <li>III. The lost son — and the running father</li>
            </ul>
            <p className="note">
              Each parable raises the cost of what is lost and the joy of its return<sup className="cite">1</sup>. The thread is the seeking love of the father, not the merit of the found<sup className="cite">2</sup> — the same grace you traced last Easter<sup className="cite">3</sup>.
            </p>
            <div className="src">
              <p className="src-l">Sources · traced to origin</p>
              <ol className="src-list">
                <li><span className="sn">1</span><span>Cross-reference · Luke 15:7 — "joy in heaven"</span></li>
                <li><span className="sn">2</span><span>Commentary · structure of the three Lukan parables</span></li>
                <li><span className="sn">3</span><span>Your note · <em>"Grace" — Easter series, last year</em></span></li>
              </ol>
            </div>
          </div>
          <div className="foot">
            <span>You write the sermon — Ezra clears the runway.</span>
    ...
    <div className="wrap pad">
      <div className="head">
        ...
        <p className="lead center mxw-60 reveal" style={{ marginTop: 16 }}>
          Logos is built for scholars with a free weekend. ChatGPT will confidently invent a citation. Ezra Research is for the pastor caught in between — real theological depth, none of the learning curve.
        </p>
      </div>
      <div className="grid cols-3" style={{ marginTop: 38 }}>
        <div className="card reveal">
          ...
          <h3 className="h3">Depth without the degree</h3>
          <p>Seminary-grade exegesis, cross-references, and commentary synthesis — without a Master's or a $3,000 library.</p>
        </div>
        <div className="card reveal" style={{ ['--d' as any]: '.08s' }}>
          ...
          <p>Every quote carries a reference. Every source is numbered. Anything Ezra can't verify is marked as background, not fact.</p>
        </div>
        <div className="card reveal" style={{ ['--d' as any]: '.16s' }}>
          ...
          <h3 className="h3">Your context, remembered</h3>
          <p>Add your commentaries, style, and past sermons once. Ezra grounds every answer in the library you've built.</p>
        </div>
      </div>
    </div>
    </section>
...
export function ProblemStats() {
  return (
    <section className="stats-band">
      <div className="wrap pad">
        <div className="head">
          <p className="eyebrow eyebrow--c reveal">The state of ministry today</p>
          <h2 className="h2 reveal" style={{ marginTop: 14 }}>Attendance is falling. <span className="mark">Pastors are stretched thin.</span></h2>
        </div>
    ...
    <section className="page active" id="features"><div className="wrap pad">
      ...
      <div className="bento" style={{ marginTop: 42 }}>
        <div className="card panel tall reveal" style={{ padding: 30 }}>
          ...
          <h3 className="h3" style={{ color: 'var(--on-slate)', margin: '18px 0 10px', fontSize: '1.5rem' }}>Ezra, your research partner</h3>
          <p style={{ color: 'var(--on-slate-2)', fontSize: '1rem', lineHeight: 1.6 }}>A conversational study partner that surfaces passages, gathers cross-references, and synthesizes commentary — so you can preach your own words. Built on orthodox theology, not a general chatbot's guesswork.</p>
        ...
        <div className="card reveal" style={{ ['--d' as any]: '.06s' }}>
          ...
          <h3 className="h3">A word-processor for sermons</h3>
          <p>A real editor with focus mode, autosave, and print-ready formatting. Built for sermon prep — not for notes.</p>
        </div>
        <div className="card reveal" style={{ ['--d' as any]: '.12s' }}>
          ...
          <p>Upload commentaries, style guides, and your own past sermons. Ezra grounds every answer in the context you've built.</p>
        </div>
        <div className="card reveal" style={{ ['--d' as any]: '.06s' }}>
          ...
          <h3 className="h3">Public-domain translations</h3>
          <p>KJV, ASV, WEB, YLT, and BBE — fully searchable, licensed clean. Licensed translations (NIV, ESV, NASB) are on the roadmap. <span className="tag tag--road" style={{ marginTop: 8 }}>Roadmap: NIV · ESV · NASB</span></p>
        </div>
        <div className="card reveal" style={{ ['--d' as any]: '.12s' }}>
          ...
          <p>Every Scripture quote ships with a parenthetical reference. Every commentary or web source is numbered. No anonymous claims.</p>
        </div>
        <div className="card reveal">
          ...
          <h3 className="h3">Built for church planters</h3>
          <p>Designed for pastors without a Master's degree and without a $3,000 Logos library. Depth without the learning curve.</p>
        </div>
        <div className="card reveal" style={{ ['--d' as any]: '.06s' }}>
          ...
          <h3 className="h3">Study depth, down to the Hebrew</h3>
          <p>Ezra is woven through the study itself, not bolted onto a chat window — surfacing the original-language text alongside your translation, with the Hebrew (and Greek) rendered in place so word studies stay one glance away, not a separate lexicon tab.</p>
        </div>
        <div className="card reveal" style={{ ['--d' as any]: '.12s' }}>
          ...
          <h3 className="h3">Find it in the Bible</h3>
          <p>Describe a theme in your own words — "a father's patience," "hope after failure" — and get back the passage that addresses it most closely, with a citation, not a guess.</p>
          <div className="bento-demo" aria-hidden="true">
            <span className="bento-demo__q">"grief that doesn't lose hope"</span>
            <span className="bento-demo__a">→ 1 Thessalonians 4:13</span>
          </div>
        </div>
      </div>
    </div></section>
  ...
  return (
    <section className="page active" id="how"><div className="wrap pad">
      <header className="head">
        ...
        <h2 className="display reveal">From passage to <span className="mark">pulpit</span>, in three moves.</h2>
        <p className="lead center mxw-52 reveal" style={{ marginTop: 16 }}>No personas to configure, no prompt-craft to learn. Just the study, the way you already do it — faster.</p>
      </header>
      <div className="steps" style={{ marginTop: 42 }}>
        <div className="card step reveal">
          ...
          <h3 className="h3">Bring the text</h3>
          <p>Drop in this week's passage or pick it from the lectionary. Ezra reads it in context — the pericope, the surrounding chapters, the original-language notes.</p>
        </div>
        <div className="card step reveal" style={{ ['--d' as any]: '.1s' }}>
          ...
          <p>Ezra surfaces cross-references, synthesizes the commentaries you've added, and pulls your own past notes. Every claim is tied to its source. Nothing anonymous.</p>
        </div>
        <div className="card step reveal" style={{ ['--d' as any]: '.2s' }}>
          ...
          <h3 className="h3">You write the sermon</h3>
          <p>Move to the editor with your research beside you. Outline, draft, and format in your own voice. Ezra clears the runway; you still preach.</p>
        </div>
      </div>
      <div className="panel reveal" style={{ marginTop: 42, padding: 'clamp(26px,4vw,44px)', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 30, alignItems: 'center' }}>
        <div>
          ...
          <p style={{ color: 'var(--on-slate-2)', lineHeight: 1.6, margin: '0 0 22px' }}>
            This is the whole loop: a passage in, a researched and cited study out, the draft still yours to write. The third source below is one of your <em style={{ color: 'var(--brass-hi)' }}>own</em> saved notes — context a general chatbot can never see.
          </p>
        ...
        <div className="study panel" style={{ boxShadow: 'none', background: 'rgba(0,0,0,.18)', borderColor: 'var(--slate-line)' }}>
          <div className="body" style={{ padding: '20px 20px 6px' }}>
            <p className="ref" style={{ fontSize: '1.1rem' }}>Romans 8 — No condemnation</p>
            <p className="note" style={{ fontSize: '.95rem', marginBottom: 18 }}>Paul moves from the law's verdict to the Spirit's freedom<sup className="cite">1</sup>, grounding assurance in adoption, not performance<sup className="cite">2</sup>.</p>
            <div className="src" style={{ paddingTop: 13 }}>
              <p className="src-l">Sources</p>
              <ol className="src-list">
                <li><span className="sn">1</span><span>Cross-reference · Romans 8:1</span></li>
                <li><span className="sn">2</span><span>Your note · <em>"Adoption" — summer series</em></span></li>
              </ol>
            </div>
          </div>
        </div>
...
export function UseCasesSection() {
  return (
    <PersonasExplorer
      ...
      subtitle="However you preach and teach, Ezra meets the work you already do — and gives the hours back. Five ministers, five weeks — find the one that sounds like yours."
      id="usecases"
    />
  );
}
  ...
  return (
    <section className="page active" id="integrations"><div className="wrap pad">
      ...
      <div style={{ maxWidth: 900, margin: '42px auto 0' }}>
        ...
        {grp("Church tools", "road", ["Planning Center", "ProPresenter", "Pushpay"])}
        {grp("Study & reference", "road", ["Logos export", "Blue Letter Bible"])}
        <p className="muted reveal" style={{ fontSize: '.86rem', textAlign: 'center', marginTop: 8 }}>
          Need something specific for your church's stack?{" "}
          <Link to="/contact" style={{ color: 'var(--brass)', textDecoration: 'underline', textUnderlineOffset: 2 }}>Tell us</Link>{" "}
          — roadmap priority follows founding-church requests.
        </p>
      </div>
    </div></section>
  );
...
const FC_JOURNEY = [
  { h: "Apply", b: "Tell us about your church or plant — where you are, what Sunday looks like, what you're hoping to build." },
  { h: "Onboard", b: "We set up your Collections together — your translations, your commentaries, the sermons you've already written." },
  { h: "Two sermon cycles", b: "Use Ezra for real prep, start to finish, on the schedule you already keep. We watch, we listen, we fix what's broken." },
  { h: "Shape the roadmap", b: "Your feedback becomes the next feature. Founding churches don't get a product built for them — they get a hand in building it." },
];
...
export function FoundingChurches() {
  return (
    <section className="page active" id="customers"><div className="wrap pad">
      <header className="head">
        <p className="eyebrow eyebrow--c reveal">Founding church program</p>
        <h2 className="display reveal">Built <span className="mark">with</span> churches — not marketed <span className="mark">to</span> them.</h2>
        <p className="lead center mxw-60 reveal" style={{ marginTop: 16 }}>A pilot for church planters and small worship-org leaders who are building something out of not much — the same way we are. This is the room we built for you, not a waitlist.</p>
      </header>
      ...
      <div className="panel fc-vision reveal" style={{ marginTop: 52 }}>
        <p className="eyebrow" style={{ color: 'var(--on-slate-2)', justifyContent: 'center' }}>For the church that doesn't exist yet</p>
        <blockquote style={{ marginTop: 18 }}>
          "Every established ministry tool was built for a church that already had the budget, the building, and the staff. We're building this one for the planter running a Bible study out of a living room, and the young minister who inherited a pulpit and a shrinking congregation — because that's who's going to fill the next generation of pews."
        </blockquote>
        <cite>— The team building Ezra Research</cite>
      </div>

      <div className="found" style={{ marginTop: 52 }}>
        <div className="grid" style={{ gap: 18 }}>
          <div className="card reveal" style={{ ['--d' as any]: '.06s' }}>
            <h3 className="h3" style={{ marginBottom: 14 }}>What founding churches get</h3>
            <div className="kv">
              ...
              <div className="kv__row">{CHECKMARK}<p><b>First access</b> to every new translation, guide type, and feature.</p></div>
            </div>
          </div>
          <div className="card reveal" style={{ ['--d' as any]: '.12s' }}>
            <h3 className="h3" style={{ marginBottom: 14 }}>What we ask</h3>
            <div className="kv">
              <div className="kv__row">{CHECKMARK}<p>Use it for <b>real prep</b> — two sermon cycles, start to finish.</p></div>
        ...
        <div className="card reveal fc-honest" style={{ padding: 32, ['--d' as any]: '.18s' }}>
          ...
          <p className="muted" style={{ lineHeight: 1.65, margin: '0 0 20px' }}>
            Most early-stage tools fill this page with stock logos and round numbers nobody can verify. We won't — when real churches are ready to be named, their stories will live here in their own words, with their own numbers. Until then, we'd rather show you the tool than a testimonial we wrote ourselves.
          </p>
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            <Link className="btn btn--ink" to="/contact">Apply to be a founding church <span className="ar">→</span></Link>
  ...
  return (
    <section className="page active" id="pricing"><div className="wrap pad">
      <header className="head">
        ...
        <p className="lead center reveal" style={{ marginTop: 16 }}>Six tiers. Start free on Manna, and grow into the one that matches your week.</p>
      </header>
      ...
      <div className="card reveal church-cta" style={{ marginTop: 32, padding: 26 }}>
        <div>
          <h3 className="h3" style={{ marginBottom: 6 }}>Multi-staff team or church network?</h3>
          <p className="muted" style={{ margin: 0 }}>Shared Collections, team onboarding, and seats across your staff — with SSO/SAML <span className="tag tag--road">Roadmap</span> on the way.</p>
        </div>
      ...
      <div className="pad-t" id="comparison">
        ...
        <div className="cmp-wrap reveal" style={{ maxWidth: 820, margin: '30px auto 0' }}>
          <table className="cmp">
            <thead><tr><th>Capability</th><th className="us us-col">Ezra Research</th><th>ChatGPT</th><th>Logos · BLB</th></tr></thead>
            <tbody>
              {[
                ["Bounded by orthodox theology","yes","no","yes"],
                ["Cites every Scripture quote","yes","no","yes"],
                ["Synthesizes commentaries (not just shows them)","yes","par","no"],
                ["Usable without a Master's degree","yes","yes","no"],
                ["Grounds answers in YOUR library","yes","no","no"],
                ["Word-processor for sermon drafting","yes","no","no"],
                ["Honest about model retention","yes","no","na"],
                ["Under $50 / month","yes","yes","no"],
              ].map(([cap, us, chat, logos]) => (
                <tr key={cap}>
                  <td>{cap}</td>
                  {[us, chat, logos].map((v, idx) => (
...
const FAQS: Array<[string, string]> = [
  ["Does Ezra write my sermon for me?", "No — and that's deliberate. Ezra does the research: it surfaces passages, gathers cross-references, and synthesizes commentary, all cited. The sermon, the conviction, and the words that go to your congregation stay yours. Preaching is pastoral integrity; we won't automate that."],
  ["How is this different from ChatGPT, Logos, or Blue Letter Bible?", "ChatGPT is fast but will confidently invent a citation and doesn't know orthodox theology. Logos is rigorous but costs thousands and assumes a seminary education. Blue Letter Bible is free and excellent, but shows you commentaries rather than synthesizing them. Ezra Research sits in the middle — depth and citations, without the cost or the learning curve — and grounds answers in the library you upload."],
  ["Which Bible translations are available?", "Public-domain translations are live now: KJV, ASV, WEB, YLT, and BBE, fully searchable. Licensed translations — NIV, ESV, NASB — are on the roadmap and will arrive properly licensed, not scraped."],
  ["Where does my data go?", "Honestly: AI requests are routed through the Lovable AI Gateway to Google Gemini and OpenAI models. We do not yet have zero-retention agreements with those providers, so we tell you plainly — don't paste confidential pastoral counseling notes. Your data is encrypted in transit and at rest, and you can delete your account anytime. See the Security page for the full posture."],
  ["Is it faithful to use AI for sermon prep?", "We think of Ezra the way you'd think of a concordance, a Greek lexicon, or commentary software — a study aid that helps you handle the text more carefully, not a substitute for the work. It cites its sources so you can check them. What you believe, and what you preach, remains between you, the Scriptures, and your congregation."],
  ["How much does it cost?", "There's a free forever tier — Manna — with no credit card. From there it's Frankincense ($9.99), Myrrh ($14.99), Silver ($19.99, the core plan), Gold ($29.99), and Diamond ($49.99), each with more tokens and sermon capacity than the last. Need more room in a given month? Top up with a pay-as-you-go token pack. Multi-staff teams and church networks get a custom plan — reach out and we'll size it to you."],
  ["Why does AI-assisted study matter right now?", "Weekly worship attendance has fallen to about 30% of U.S. adults, down from 42% two decades ago (Gallup, 2026), while 90% of pastors report being frequently fatigued or worn out (Pastoral Care, Inc. / Schaeffer Institute survey of 1,050 pastors). Fewer people in the pews and more strain on the person in the pulpit means every hour spent hunting through commentaries is an hour not spent on people. Ezra exists to give that hour back."],
];
...
const SEC = [
  ...
  { t: "AI provider transparency", b: "AI requests route through the Lovable AI Gateway to Google Gemini and OpenAI models. We do not currently have zero-retention agreements with upstream providers — so don't paste confidential pastoral counseling notes.", path: <path d="M12 3l8 4v5c0 5-3.5 8-8 9-4.5-1-8-4-8-9V7l8-4z"/> },
  ...
  { t: "Account controls", b: "Email/password and Google sign-in are supported. SAML SSO is planned for Church plans. Delete your account at any time and your data is purged within 30 days.", path: <><path d="M16 21v-2a4 4 0 00-4-4H7a4 4 0 00-4 4v2M9.5 11a4 4 0 100-8 4 4 0 000 8zM19 8l2 2 2-2"/></> },
];
...
export function ChangelogSection() {
  const items = [
    ["v1.0", "June 1, 2026", "Mobile implementation — full research and drafting on a phone, for prep that happens between meetings."],
    ["v0.1.2", "May 2, 2026", "Significant improvements to Ezra's research quality and citation accuracy."],
    ["v0.1.1", "April 1, 2026", "Enhanced Collections, editor refinements, and general improvements."],
    ["v0.1", "March 1, 2026", "Initial MVP — Ezra research partner, the sermon editor, and the File Cabinet."],
  ];
  return (
...
export function BlogSection() {
  const posts = [
    ["Craft","Preaching to a congregation that's holding a phone","What changes — and what doesn't — when half the room can fact-check you in real time."],
    ["Study","ESV vs. NLT for pastoral care","Two faithful translations, two different jobs. When to reach for which, and why it matters at a hospital bedside."],
    ["Ethics","Is it faithful to use AI in the study?","The honest case for — and the lines we refuse to cross — from the people building the tool."],
  ];
  return (
    <section className="page active" id="blog"><div className="wrap pad">
      <header className="head" style={{ textAlign: 'left', maxWidth: 760, marginLeft: 0 }}>
        ...
        <p className="lead reveal mxw-52">Product thinking, study craft, and the occasional strong opinion. First essays are on the way.</p>
      </header>
...
const CONTACT_FIELDS = [
  ["Email", "hello@ezraresearch.ai", "We read every message ourselves.", <><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 7l9 6 9-6"/></>],
  ["Support", "support@ezraresearch.ai", "Typically within one business day.", <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/>],
] as const;
...
function useContactForm() {
  ...
  const submit = (e: React.FormEvent) => {
    ...
    const subject = values.subject.trim() || "Message from ezraresearch.ai";
    const body = `${values.message}\n\n— ${values.name} (${values.email})`;
    window.location.href = `mailto:hello@ezraresearch.ai?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };
      ...
      <div className="cct" style={{ marginTop: 38 }}>
        <div className="cct__info">
          ...
          <div className="panel info-founding reveal" style={{ ['--d' as any]: '.12s' }}>
            <p className="eyebrow" style={{ color: 'var(--on-slate-2)' }}>Founding churches</p>
            <h3 className="h3" style={{ color: 'var(--on-slate)', margin: '12px 0 10px' }}>Planting or leading a small church?</h3>
            <p style={{ color: 'var(--on-slate-2)', fontSize: '.9rem', lineHeight: 1.6, margin: '0 0 20px' }}>We reply within a day, always a real person — and there's a whole program built for churches like yours.</p>
            <Link className="btn btn--ink btn--sm" to="/customers">See the founding church program <span className="ar">→</span></Link>
          </div>
        </div>
...
const LEARN_GUIDES = [
  {
    ...
    topics: ["A tour of your study", "Your first week"],
  ...
  },
  {
    ...
    topics: ["Asking better study questions", "Grounding answers in your own library"],
  ...
  return (
    <section className="page active" id="learning"><div className="wrap pad">
      <header className="head">
        ...
        <p className="lead center mxw-60 reveal" style={{ marginTop: 16 }}>Guides for every room of the study, answers to the questions we hear most, and — coming soon — a place to just ask.</p>
      </header>
      ...
      <div className="pad-t">
        <div className="panel learn-ask reveal">
          ...
          <p style={{ color: 'var(--on-slate-2)', maxWidth: '56ch' }}>A place to ask your own question about Ezra Research in plain language and get a real answer back — no digging through guides. We're building it now.</p>
          <div className="learn-ask__input">
            <input disabled placeholder="Ask anything about Ezra Research…" aria-label="Ask a question (coming soon)" />
  ...
  return (
    <section className="page active" id="about"><div className="wrap">
      <div className="pad" style={{ textAlign: 'center' }}>
        ...
        <h2 className="display reveal" style={{ marginTop: 18 }}>A research partner.<br/><span className="mark">Not a pulpit replacement.</span></h2>
      </div>
      <hr className="divline" />
      <div className="pad about-sec">
        <p className="eyebrow reveal" style={{ marginBottom: 18 }}>The problem · good tools, wrong people</p>
        <p className="reveal">Logos is a serious theological research environment. It is also $3,000 for a usable library and assumes you have a Master's degree and a free weekend to learn the interface. Blue Letter Bible is free and brilliant, but it shows you commentaries instead of synthesizing them. ChatGPT is fast and synthesizes everything — but it does not know orthodox theology from a hole in the ground, and it will not cite a verse it cannot find.</p>
        <p className="reveal">Most pastors planting churches today are caught in the middle: more theological depth than ChatGPT can responsibly produce, less time and money than Logos requires.</p>
        <p className="reveal">
          And the stakes are rising. Weekly worship attendance has fallen to about 30% of U.S. adults, down from 42% two decades ago<sup className="cite">1</sup>. At the same time, 90% of pastors report being frequently fatigued or worn out, and every one of 1,050 pastors surveyed knew a colleague who left ministry over burnout, conflict, or moral failure<sup className="cite">2</sup>. Fewer people in the pews and more strain on the person in the pulpit — that's exactly the gap a research partner should close, not widen.
        </p>
        <div className="src" style={{ marginTop: 18 }}>
          <p className="src-l">Sources · traced to origin</p>
          <ol className="src-list">
            <li><span className="sn">1</span><span>Gallup, "Church Attendance Has Declined in Most U.S. Religious Groups" (2026)</span></li>
            <li><span className="sn">2</span><span>Pastoral Care, Inc., Statistics for Pastors — Schaeffer Institute survey of 1,050 pastors</span></li>
          </ol>
        </div>
        <p className="reveal"><strong>Ezra Research exists for that middle.</strong></p>
      </div>
      <hr className="divline" />
      <div className="pad about-sec">
        <p className="eyebrow reveal" style={{ marginBottom: 18 }}>The philosophy · research, then preach</p>
        <p className="reveal">Ezra — named after the scribe and teacher of the Law — is a research companion. It outlines exegesis, gathers cross-references, and synthesizes commentary. It will not preach your sermon for you. Preaching is pastoral integrity. That stays with you.</p>
      </div>
      <div className="wrap" style={{ paddingBottom: 0 }}>
        <div className="grid cols-3">
          <div className="card reveal"><h3 className="h3" style={{ marginBottom: 10 }}>Citations on every claim</h3><p>Every Scripture quote ships with a parenthetical reference. Every commentary or source is numbered. Anything we cannot verify is marked as background, not fact.</p></div>
          <div className="card reveal" style={{ ['--d' as any]: '.06s' }}><h3 className="h3" style={{ marginBottom: 10 }}>Bounded by orthodoxy</h3><p>Non-sectarian by default, historically orthodox in framing. Honors your stated tradition without proselytizing other traditions.</p></div>
      ...
      <div className="pad about-sec">
        <p className="eyebrow reveal" style={{ marginBottom: 18 }}>The commitment · built for church planters</p>
        <p className="reveal">Our first user is the non-denominational church planter under 40 — serious about study, light on budget, allergic to fluff. If we serve that pastor well, we earn the right to serve seminaries, established staff teams, and lay leaders. Not before.</p>
        <p className="reveal">We are working with a hand-picked group of founding pastors right now to get the tool, the citations, and the workflow correct before we open the doors wider.</p>
      </div>
      <div className="pad" style={{ paddingTop: 0 }}>
        <blockquote className="pullquote reveal">
          <q>For Ezra had prepared his heart to seek the law of the LORD, and to do it, and to teach in Israel statutes and judgments.</q>
          <cite>Ezra 7:10 · KJV</cite>
        </blockquote>
      </div>
    </div></section>
  );
